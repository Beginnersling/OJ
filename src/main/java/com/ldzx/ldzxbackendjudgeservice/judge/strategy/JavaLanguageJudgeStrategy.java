...
import com.ldzx.ldzxojbackendmodel.model.dto.question.JudgeConfig;
import com.ldzx.ldzxojbackendmodel.model.entity.Question;
import com.ldzx.ldzxojbackendmodel.model.enums.JudgeInfoMessageEnum;
...
public class JavaLanguageJudgeStrategy implements JudgeStrategy {
    ...
    public JudgeInfo doJudge(JudgeContext judgeContext) {
        ...
        long JAVA_PROGRAM_COST =  10000L;

        if(time - JAVA_PROGRAM_COST > needTimeLimit){
